...
def main():
        ...
        train_data = creat_data(100000, 400, 0.1)
        np.savetxt("train_file_400atb.csv", train_data, delimiter=",")

        # produce test dataset
        test_data = creat_data(50000, 400, 0.1)
        np.savetxt("test_file_400atb.csv", test_data, delimiter=",")

        # produce even test dataset
        test_data_even = creat_data(50000, 400, 0.5)
        np.savetxt("test_file_400atb_even.csv", test_data_even, delimiter=",")
