...
X_train, y_train = fipr.load_csv("train_file_curve.csv", True)
X_test, y_test = fipr.load_csv("test_file_curve.csv", True)
y_train = y_train.flatten() 
y_test = y_test.flatten()
time_load_end = time.clock()
print("Loading finished, loading time: %g seconds" % (time_load_end - time_load_start))

X_test_even, y_test_even = fipr.load_csv("test_file_curve_even.csv", True)
