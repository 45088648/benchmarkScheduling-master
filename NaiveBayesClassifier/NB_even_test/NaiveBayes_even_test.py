### Naive Bayes Classifier-using sklearn package
...
# perform prediction on even test set
...
print('Accuracy on even test:  ' + str(fipr.compute_accuracy(y_test_even, y_pred_even)))
